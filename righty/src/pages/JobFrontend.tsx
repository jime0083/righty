...
const jobData = {
  eyebrow: 'Job',
  title: 'フロントエンドエンジニア',
  lead: 'Webサイトやサービスのフロントエンド開発で、\n快適で魅力的な体験をつくります。',
  about: {
    description: 'React、TypeScript、Next.jsなどのモダンな技術スタックを用いて、ユーザーにとって快適で魅力的なWebアプリケーションを開発します。デザイナーと密に連携しながら、パフォーマンスとアクセシビリティを意識した実装を行い、プロダクトの価値向上に貢献します。',
    image: 'job_frontend_crop.png'
  },
  manager: {
    message: 'フロントエンドエンジニアは、ユーザーが直接触れる部分を担当する重要なポジションです。ライティでは、最新の技術トレンドを追いながらも、本質的なユーザー体験を大切にしています。デザイナーやバックエンドエンジニアと協力し、チームでより良いプロダクトをつくる環境で、あなたの技術力を発揮してください。',
    role: 'フロントエンドチーム マネージャー',
    name: '山田 太郎',
