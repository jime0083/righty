...
const jobData = {
  eyebrow: 'Job',
  title: 'セールス',
  lead: 'クライアントの課題を深く理解し、\n最適なソリューションを提案します。',
  about: {
    description: 'クライアントの経営課題やビジネスニーズを深く理解し、ライティのサービスを通じて最適なソリューションを提案します。新規開拓から既存顧客のリレーション構築まで幅広く担当し、クライアントのビジネス成長に貢献します。社内のデザイナーやエンジニアと連携しながら、プロジェクトを成功に導きます。',
    image: 'cult_connect.png'
  },
  manager: {
    message: 'セールスは、クライアントとライティをつなぐ架け橋となる重要なポジションです。単なる営業ではなく、クライアントの課題を深く理解し、本質的な価値を提供することを大切にしています。チームで知見を共有しながら成長できる環境で、あなたの提案力とコミュニケーション力を発揮してください。',
    role: 'セールスチーム マネージャー',
    name: '渡辺 直樹',
